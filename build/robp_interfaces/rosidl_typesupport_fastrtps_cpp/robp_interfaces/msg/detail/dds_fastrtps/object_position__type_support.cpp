...
#include "robp_interfaces/msg/detail/object_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robp_interfaces::msg::ObjectPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robp_interfaces::msg::ObjectPosition & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robp_interfaces::msg::ObjectPosition;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robp_interfaces
max_serialized_size_key_ObjectPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const robp_interfaces::msg::ObjectPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robp_interfaces::msg::ObjectPosition *>(
    untyped_ros_message);
...
{
  return &robp_interfaces::msg::typesupport_fastrtps_cpp::_ObjectPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robp_interfaces, msg, ObjectPosition)() {
  return &robp_interfaces::msg::typesupport_fastrtps_cpp::_ObjectPosition__handle;
}
