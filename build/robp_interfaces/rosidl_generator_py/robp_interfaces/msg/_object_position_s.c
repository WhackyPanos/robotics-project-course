...
bool robp_interfaces__msg__object_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robp_interfaces.msg._object_position.ObjectPosition", full_classname_dest, 51) == 0);
  }
  robp_interfaces__msg__ObjectPosition * ros_message = _ros_message;
  {  // header
...
PyObject * robp_interfaces__msg__object_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robp_interfaces.msg._object_position");
