...
#include "robp_interfaces/msg/detail/object_position__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectPosition__ros_msg_type = robp_interfaces__msg__ObjectPosition;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robp_interfaces__msg__ObjectPosition;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robp_interfaces__msg__ObjectPosition * ros_message = static_cast<const robp_interfaces__msg__ObjectPosition *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robp_interfaces__msg__ObjectPosition(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robp_interfaces__msg__ObjectPosition * ros_message = static_cast<robp_interfaces__msg__ObjectPosition *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robp_interfaces__msg__ObjectPosition(cdr, ros_message);
}

static uint32_t _ObjectPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robp_interfaces__msg__ObjectPosition(
...
static size_t _ObjectPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robp_interfaces__msg__ObjectPosition(
