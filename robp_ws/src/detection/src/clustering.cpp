                            ...
                            .automatically_declare_parameters_from_overrides(true)) 
{
    ...
    this->get_parameter_or("ang_velocity_threshold", ang_velocity_threshold_, 0.3);
...
void Clustering::cloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
    ...
    // Only cluster if robot is not rotating too much
    if (std::abs(angular_z_) < ang_velocity_threshold_)
    {
