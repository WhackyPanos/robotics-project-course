    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[{
                ...
                "max_correspondence_distance": 0.01,  # Maximum distance between corresponding points in source and target clouds
                "maximum_iterations": 20000,  # Maximum number of iterations for ICP to refine alignment
                "transformation_epsilon": 1e-4,  # Convergence criterion: minimum change in transformation between iterations
                "euclidean_fitness_epsilon": 1e-3,  # Convergence criterion: minimum mean squared error change between iterations
