...
**For the setup of the environment, including ROS2 installation and workspace, micro-ROS installation and setup of the IDE **please see** the [Setup README](https://github.com/KTH-CAS-UAV/robp_arm/blob/vt25/Hiwonder_xArm_ROS2/SETUP_README.md).**


### **Test System: Ubuntu 24.04 on WSL, ROS2 Jazzy, Micro-ROS, ESP32-DevkitC-32E with PlatformIO in VS Code as the dev environment**
