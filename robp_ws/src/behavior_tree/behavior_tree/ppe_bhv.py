...
class A_PlanPath(py_trees.behaviour.Behaviour, Node): # this class is a py_tree node and a ros node
    ...
    def setup(self, **kwargs):
        ...
        self.path_is_needed = True
        self.subs = self.node.create_subscription(Bool, '/path/is_needed', self.callback, 10)

        # topic in which the msg will be published
        self.path_pub = self.node.create_publisher(Path, '/goal/path', 10)
    ...
    def update(self):
        ...
        if not self.path_is_needed:
            return py_trees.common.Status.SUCCESS
        else: 
            # TODO: path planner has to be executed and a msg has to be published
            pass
    ...
    def callback(self, msg):
         self.path_is_needed = msg.data

# ----------------------------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------


class A_MoveRobot(py_trees.behaviour.Behaviour, Node): # this class is a py_tree node and a ros node
    def __init__(self, name="PlanPath"):
        super().__init__(name=name)
...
class I_UpdateObjectList(py_trees.behaviour.Behaviour, Node): # this class is a py_tree node and a ros node
    def __init__(self, name="PlanPath"):
        super().__init__(name=name)
...
class I_NextObject(py_trees.behaviour.Behaviour, Node): # this class is a py_tree node and a ros node
    def __init__(self, name="PlanPath"):
        super().__init__(name=name)
